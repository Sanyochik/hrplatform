...
if (Yii::$app->user->isGuest) {
    ...
    $menuItems[] = ['label' => 'Сотрудники',
            'url' => ['/svaz/index'],
            'options' => ['class' => 'dropdown'],
            'items' => [
                ['label' => 'Праздники', 'url' => ['/holidays/index']],
                ['label' => 'Статистика по вопросам', 'url' => ['/statis/index']],
                ['label' => 'Диаграмма', 'url' => ['/svaz/diagramm?questions=1&questions1=1&questions4=4&questions6=6&questions12=12&questions2=2&questions3=3&questions5=5&questions7=7&questions9=9&questions10=10']],
                ['label' => 'Пользователи', 'url' => ['/svaz/index']],
                ['label' => 'Вопросы', 'url' => ['/question/index']],
            ],
        ];
    $menuItems[] = ['label' => 'Корпаративный портал', 'url' => '/site/corp'];
    $menuItems[] = '<li>'
    ...
    $menuItems = [
        ...
        ['label' => 'Карта связи', 'url' => ['/site/select']],
        ['label' => 'Оценка коллег', 'url' => ['/site/contact']],
        ['label' => 'Корпаративный портал', 'url' => ['/site/corp']],
